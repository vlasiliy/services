...
--
-- Хост: localhost
-- Время создания: Янв 28 2014 г., 23:57
...
CREATE TABLE IF NOT EXISTS `photo` (
  ...
  `filename` varchar(36) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `project` (`id`, `user_id`, `category_id`, `name`, `date_finished`, `price`, `currency`, `unit`, `description`, `sort`) VALUES
(1, 2, 6, 'Тестовый проект', '2014-01-21 13:30:39', 202, 'USD', 'час', '', 1),
(3, 7, 5, 'Тестовый проект 1', '2014-01-21 13:30:39', 20, 'UAH', 'час', '', 3);
...
(1, 'admin', 'vlasiliy@gmail.com', 'b8811d34d454be08f90008373a16c4b7', 'admin', '', 'Василий', 'Пупкин', 1, '', '', '', '', '', '', '', '', '', 0.00000000000000000, 0.00000000000000000, '2013-08-06 09:15:25', '0000-00-00 00:00:00', '2014-01-28 20:48:34', 0, 0, 0),
(2, 'user', 'anli_v@mail.ru', 'b8811d34d454be08f90008373a16c4b7', 'anli', '4aed04fa9c8b04824f8061c98a8091e6.jpg', 'Анатолий', 'Иванов', 1, '', 'Черкассы', '20700', 'ул. Ленина 123, кв. 10', '096534986523423', '', 'http://www.test.com', 'anli_v', '', 50.44859362534486000, 30.51115114241850000, '2013-10-18 13:18:52', '2014-01-27 21:54:56', '2013-10-27 12:30:00', 0, 1, 0),
